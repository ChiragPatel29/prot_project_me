...
function RegisterRoutes() {
    return {
        customRoutes: [
            ...
            {route: 'myprofile', template: 'myprofile/template', controller: 'myprofile'},
        ...
        easyRoutes: ['organizations', 'users', 'groups', 'categories', 'tasks','profiles','projects','user_stories','leaves','timesheets','bugs','milestones'], // Provide the names of your tables here and make a copy of app/modules/tasks with the same name
        autoRoutes: ['departments','designations'
...
app.controller('bugsControllerExtension', function($scope, $controller, $rootScope, $http, $location, Popup, H, M) {
    ...
    // Date Comparision functionality
...
//'autoRoutes' and then override the templates using setTemplate function.
//Note that for 'autoRoutes', it is not even required to write Controller Extensions unless you want to modify the behaviour.
app.controller('user_storiesControllerExtension', function($scope, $controller, $rootScope, $http, $location, Popup, H, M) {
